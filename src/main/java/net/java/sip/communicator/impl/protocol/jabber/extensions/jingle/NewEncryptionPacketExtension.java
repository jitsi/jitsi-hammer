 ...
 * @author Emil Ivov
 */
public class NewEncryptionPacketExtension
        extends NewAbstractExtensionElement
{
     ...
     */
    private List<NewCryptoPacketExtension> cryptoList
            = new ArrayList<NewCryptoPacketExtension>();

    /**
     * Creates a new instance of this <tt>NewEncryptionPacketExtension</tt>.
     */
    public NewEncryptionPacketExtension()
    {
     ...
     */
    public void addCrypto(NewCryptoPacketExtension crypto)
    {
     ...
     * we have registered with this encryption element so far.
     */
    public List<NewCryptoPacketExtension> getCryptoList()
    {
        return cryptoList;
    }
    ...
    public void addChildExtension(Element childExtension)
    {
        ...
        if(childExtension instanceof NewCryptoPacketExtension)
        {
            this.addCrypto(((NewCryptoPacketExtension) childExtension));
        }
    }
}
