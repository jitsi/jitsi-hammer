 ...
 */
public class NewRTPHdrExtPacketExtension
        extends NewAbstractExtensionElement
{
     ...
     * Constructor.
     */
    public NewRTPHdrExtPacketExtension()
    {
        super(ELEMENT_NAME, NAMESPACE);
    }

    public NewRTPHdrExtPacketExtension(NewRTPHdrExtPacketExtension ext)
    {
        this();
    ...
    {
        NewParameterPacketExtension paramExt =
                new NewParameterPacketExtension();
    ...
    {
        for(Element ext : getChildExtensions())
        {
            if(ext instanceof NewParameterPacketExtension)
            {
                NewParameterPacketExtension p = (NewParameterPacketExtension)ext;
