 ...
 * 
 * !WARNING! We need to retain this <tt>AbstractPacketExtension</tt>
 * implementation here to keep it compatible with both Smack 4 which uses
 * <tt>CharSequence</tt> as return type for its XML retrieving methods,
 * and Jitsi's inheritors of <tt>PacketExtension</tt> which rely on Smack3
 * API
 * 
 */
