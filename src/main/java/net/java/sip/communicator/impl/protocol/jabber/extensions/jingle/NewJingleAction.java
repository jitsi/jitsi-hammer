...
public enum NewJingleAction
{
    ...
    /**
     * Creates a <tt>NewJingleAction</tt> instance with the specified name.
     *
     * @param actionName the name of the <tt>NewJingleAction</tt> we'd like
     * to create.
     */
    private NewJingleAction(String actionName)
    {
    ...
    /**
     * Returns the name of this <tt>NewJingleAction</tt> (e.g. "session-initiate"
     * or "transport-accept"). The name returned by this method is meant for
     * use directly in the XMPP XML string.
     *
     * @return Returns the name of this <tt>NewJingleAction</tt> (e.g.
    ...
    /**
     * Returns a <tt>NewJingleAction</tt> value corresponding to the specified
     ...
     * parse.
     * @return a <tt>NewJingleAction</tt> value corresponding to the specified
     * <tt>jingleActionStr</tt> or <tt>null</tt> if given <tt>String</tt> can
     * not be matched with any of enumeration values.
     */
    public static NewJingleAction parseString(String jingleActionStr)
    {
        for (NewJingleAction value : values())
