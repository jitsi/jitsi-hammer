 ...
 */
public class NewCryptoPacketExtension
        extends NewAbstractExtensionElement
{
    ...
    /**
     * Creates a new {@link NewCryptoPacketExtension} instance with the proper
     * element name and namespace.
     */
    public NewCryptoPacketExtension()
    {
     ...
     */
    public NewCryptoPacketExtension(SrtpCryptoAttribute cryptoAttribute)
    {
        this();
    ...
    public boolean equalsCryptoSuite(String cryptoSuite)
    {
        ...
        return NewCryptoPacketExtension.equalsStrings(
                currentCryptoSuite,
                cryptoSuite);
    }
    ...
    /**
     * Returns if the current NewCryptoPacketExtension equals the one given in
     * parameter.
     *
     * @param obj an object which might be an instance of NewCryptoPacketExtension.
     *
    ...
    {
        if(obj instanceof NewCryptoPacketExtension)
        {
            NewCryptoPacketExtension crypto = (NewCryptoPacketExtension) obj;
